 ...
 *
 * $Id: move_albumitem.php 15959 2007-03-09 11:24:17Z jenst $
*/
...
if ($reorder ) { // Reorder, intra-album move
	...
	echo makeFormIntro('move_albumitem.php',
		array(),
	...
	echo "\n<br><br>";
	echo gSubmit ('submit', $reorder ? gTranslate('core','Re_order it!') : gTranslate('core','_Move it!'));
	echo gButton('close', gTranslate('core', "_Cancel"), 'parent.close()');
	echo "\n</form>";
